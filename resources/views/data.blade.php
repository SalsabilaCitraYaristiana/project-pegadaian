...
<head>
    ...
    <title>Pengajuan Gadai</title>
    <link rel="stylesheet" href="{{asset('assets/css/style.css')}}">
</head>
<body>
    <h2 class="title-table">Pengajuan Gadai</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                if ($report->response) {
                    $pesanWa = 'Hallo' . $report->nama . '! pegadaian anda di' . $report->response['status'] . '. Berikut pesan untuk anda : '. $report->response['pesan'];
                }
